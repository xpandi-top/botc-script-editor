...
import { useCommunicationCanvas, type DrawState } from './useCommunicationCanvas'
...
export function CommunicationBoard({ open, onClose, scriptCharacters, language }: CommunicationBoardProps) {
  ...
  const { canvasRef, initCanvas, clearCanvas, undo, startDraw, draw, endDraw } = useCommunicationCanvas(drawState)
