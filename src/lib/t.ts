...
export type UiKey =
  ...
  | 'add_folder' | 'add_script' | 'autogenerated_from_script_date_if_blank' | 'changelog' | 'character' | 'characters_played' | 'chat'
