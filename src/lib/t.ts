...
export type UiKey =
  ...
  | 'library_missing_roles' | 'community_script' | 'community_pack'
  ...
  | 'calculated' | 'actual_short' | 'adjusted_for_setup' | 'setup_checks' | 'script_switch_keeps_seats' | 'change_to' | 'n_games_suffix'
  ...
  | 'seat_number_helper' | 'show_my_character' | 'hide_my_character'
  ...
  | 'lock_all' | 'unlock_all' | 'lock_all_hint' | 'unlock_all_hint'
  ...
  | 'player_assignments' | 'draw_deal_tab' | 'messages_tab' | 'coming_soon'
  ...
  | 'let_players_claim_their_own_seat' | 'claim_seats_button'
  | 'no_active_session_start_one_from_draw_deal'
  | 'send' | 'no_messages_yet' | 'you_label' | 'storyteller_label' | 'broadcast_to_all_seats'
  | 'random_assign_characters_hint'
  | 'send_assigned_characters' | 'send_assigned_characters_hint' | 'delivered' | 'pending_delivery'
