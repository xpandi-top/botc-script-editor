...
/**
 * Who each seat was at the start of the day and every later role/alignment
 * change. `complete: false` means the history started mid-game (older saves),
 * so derived counts are unknown rather than zero.
 */
