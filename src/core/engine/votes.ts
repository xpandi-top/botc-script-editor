/**
 * Vote counting and Odyssey vote tokens. Pure; shared by the web UI and the
 * planned game engine / API.
 */
import type { StorytellerSeat, VoteDraft, VotingState } from '../types/game'
